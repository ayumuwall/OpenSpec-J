...
このリポジトリは、[Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) をベースにした日本語ローカライズ版（OpenSpec-J）です。仕様と構成は本家を尊重しつつ、日本語利用者向けにドキュメントとメッセージを最適化しています。**現在の同期元は OpenSpec v0.23.0 です。**
...
<!-- OPENSPEC-J:NOTE-START source-of-truth -->
```
┌────────────────────┐
│ 変更提案ドラフト     │
│ (下書き)            │
...
<!-- OPENSPEC-J:NOTE-END source-of-truth -->
